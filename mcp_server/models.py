...
class CertificateParameters(BaseModel):
    APPNO: str = Field(
        ..., description='Application No', examples=['AUTINCTEHC-2015-3']
    )
    CERTNO: str = Field(
        ..., description='Certificate No', examples=['TEHC-INCOME-2015-1']
    )
...
class CertificateParameters3(BaseModel):
    CERTNO: str = Field(
        ..., description='Certificate No', examples=['DSW-SWIDCSNC-2001-100']
    )
    DOB: str = Field(
...
class SicrdCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters3] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
    )
...
class SicrdCertificatePostResponse(BaseModel):
...
class SicrdCertificatePostResponse1(BaseModel):
...
class SicrdCertificatePostResponse2(BaseModel):
...
class SicrdCertificatePostResponse3(BaseModel):
...
class SicrdCertificatePostResponse4(BaseModel):
...
class SicrdCertificatePostResponse5(BaseModel):
...
class SicrdCertificatePostResponse6(BaseModel):
